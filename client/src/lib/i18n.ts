...
export const translations = {
  en: {
    ...
    contact: {
      ...
      pricingInfo: "Pricing: $1 USD for 100 credits or ¥7 CNY for 100 credits",
      pricingNote: "We'll contact you with pricing and payment details.",
  ...
  zh: {
    ...
    contact: {
      ...
      pricingInfo: "定价：1美金100积分 或 7人民币100积分",
      pricingNote: "我们会联系您告知价格和支付详情。",
